...
export function crearNuevoProductoAction(producto) {
    return async (dispatch) => {
        ...
        try {
            ...
            // Si todo sale bien
            dispatch(agregarPructoExito(producto));
            ...
            console.log(error);
            // Si hay un error cambiar el estate
            dispatch(agregarPructoError(true));
            Swal.fire({
                icon: 'error',
                title: 'Hubo un error',
...
const agregarPructoExito = producto => ({
    type: AGREGAR_PRODUCTO_EXITO,
    payload: producto
});

// Si hubo un error
const agregarPructoError = estado => ({
